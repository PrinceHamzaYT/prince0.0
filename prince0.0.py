...
----------------------------------------------
 Author    : PrinceHamzaYT
 Github    : PrinceHamzaYT
 YOUTUBE   : PrinceHamzaYT
 Tool Name : PR TOOL
 Type type : Free
 Version   : 0.3
\033[1;37m----------------------------------------------""")
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://youtube.com/@princehamzayt6210/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://youtube.com/@princehamzayt6210="
